...
utility(o("emp"),-20.61327506581482).
utility(r("big"),-20.06313851755354).
utility(e("high"),37.566288241583685).
utility(a("old"),20.48093840641397).
utility(\+(e("uni")),-4.433711758416313).
utility(s("M"),7.158196691657057).
utility(\+(r("small")),-8.063138517553542).
utility(\+(a("adult")),-54.65720660822696).
