...
utility(e("high"),-49.160324705317514).
utility(\+(a("old")),18.57792576733201).
utility(t("train"),38.261547352880996).
utility(t("car"),-39.06471779952587).
utility(r("big"),-18.694408590890337).
utility(e("uni"),21.37044630952774).
utility(\+(r("small")),19.305591409109663).
utility(\+(a("adult")),13.131139045223508).
