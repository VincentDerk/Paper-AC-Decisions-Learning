...
utility(r("small"),2.955401795767255).
utility(\+(o("self")),32.23355572044171).
utility(\+(r("big")),45.95540179576726).
utility(s("M"),-50.872814442388474).
utility(o("emp"),-28.766444279558296).
utility(t("car"),-33.34631728866877).
utility(\+(t("other")),15.150325585753144).
utility(s("F"),12.63226856719249).
