...
utility(\+(o("emp")),-8.433438156947558).
utility(e("high"),40.179924058587474).
utility(a("young"),-46.65614998838735).
utility(\+(t("other")),-32.09808628660868).
utility(a("old"),34.76231149985603).
utility(o("self"),-8.433438156947558).
utility(s("F"),24.330067531450183).
utility(\+(r("small")),15.40259805398173).
