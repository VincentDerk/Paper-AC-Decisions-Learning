...
utility(\+(s("F")),-28.1635768484752).
utility(a("young"),-44.5252307157412).
utility(e("high"),3.583241275124879).
utility(s("M"),-28.1635768484752).
utility(t("other"),26.052282938553727).
utility(o("self"),17.25936239175111).
utility(a("old"),-36.631620399674176).
utility(\+(a("old")),47.77975260327287).
utility(t("car"),-26.169247297120346).
