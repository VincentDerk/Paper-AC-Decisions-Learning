...
utility(\+(smoke),-30.17878054177423).
utility(\+(tub),34.74054283456681).
utility(asia,0.408384720096986).
utility(\+(xray),23.08997934256514).
utility(dysp,-17.41625092389805).
utility(lung,7.773842704571287).
utility(\+(lung),22.507415931378965).
