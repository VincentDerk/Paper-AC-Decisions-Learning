...
utility(s("F"),-24.398844165863885).
utility(a("young"),-50.22152590078542).
utility(s("M"),20.39806350398071).
utility(\+(s("M")),-24.398844165863885).
utility(o("emp"),34.104111520100666).
utility(o("self"),-38.10489218198382).
utility(t("car"),33.40311730383933).
