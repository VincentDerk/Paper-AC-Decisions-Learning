...
utility(johnCalls,43.83479979039744).
utility(\+(johnCalls),11.56712525881348).
utility(maryCalls,25.1282017768276).
utility(alarm,38.48121357056976).
utility(\+(alarm),16.92071147864122).
