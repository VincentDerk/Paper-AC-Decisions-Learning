...
utility(\+(smoke),10.357864893474728).
utility(either,-20.859218521148527).
utility(tub,-2.644689177421811).
utility(xray,-11.33753790927366).
utility(\+(xray),-3.430626072982377).
utility(lung,-18.45624689283012).
