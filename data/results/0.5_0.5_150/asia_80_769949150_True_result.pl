...
utility(\+(either),28.003710484709746).
utility(\+(asia),-10.804661531229558).
utility(smoke,-33.75112053249925).
utility(\+(bronc),7.187544012612071).
utility(tub,19.850930521975677).
utility(lung,34.52373519492158).
utility(\+(lung),12.824059573912526).
