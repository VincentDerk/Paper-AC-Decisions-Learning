...
utility(r("big"),31.281445525679604).
utility(t("car"),-0.622909076786546).
utility(s("M"),18.546977873041854).
utility(a("adult"),29.195231992429328).
utility(e("uni"),-48.70660833157103).
utility(\+(s("M")),-43.92486788060899).
utility(t("train"),-22.756525099881156).
