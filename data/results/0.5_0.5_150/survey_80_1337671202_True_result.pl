...
utility(t("car"),-5.570541551507926).
utility(a("adult"),25.010889292508384).
utility(r("big"),1.038920202145489).
utility(s("M"),-19.789763363808873).
utility(s("F"),4.843226062555644).
utility(\+(r("big")),-52.985457503398706).
utility(t("train"),39.60690147494313).
