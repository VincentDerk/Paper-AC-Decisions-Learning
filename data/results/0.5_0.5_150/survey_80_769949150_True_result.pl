...
utility(o("self"),8.78521721591891).
utility(a("adult"),-13.62578788266472).
utility(r("big"),-11.937840441448248).
utility(\+(t("car")),-30.307596401921245).
utility(s("F"),4.575336523714733).
utility(\+(a("old")),23.221351578487646).
utility(s("M"),-25.205157323280545).
utility(r("small"),-8.691980358117563).
utility(a("old"),-43.85117237805346).
