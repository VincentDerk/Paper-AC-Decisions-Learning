...
utility(burglary,46.325743063295235).
utility(\+(burglary),5.439704599486722).
utility(maryCalls,34.25622651354637).
utility(alarm,14.307980476171501).
utility(\+(alarm),21.45746718661046).
