...
utility(o("emp"),6.420343175229995).
utility(e("high"),29.10247789024939).
utility(s("M"),-18.900296852213852).
utility(a("young"),-49.68991358408957).
utility(r("small"),30.739774134252826).
utility(t("train"),13.934505961215166).
utility(\+(t("train")),-50.92734212089874).
