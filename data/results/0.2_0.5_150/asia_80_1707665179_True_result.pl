...
utility(\+(bronc),15.359615599518804).
utility(lung,10.741927882578135).
utility(smoke,31.848480855079924).
utility(dysp,-16.413690244978774).
utility(\+(dysp),-4.791340969057349).
utility(xray,-42.216523594992395).
