...
utility(t("other"),-1.778092177524114).
utility(r("big"),-43.9695104662453).
utility(a("adult"),28.388820519027252).
utility(\+(a("adult")),-40.048482643232916).
utility(e("uni"),18.223304795828486).
utility(e("high"),-29.88296692003415).
utility(t("train"),31.04260787885134).
