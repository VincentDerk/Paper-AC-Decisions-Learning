...
utility(\+(t("other")),-33.32184461582109).
utility(r("big"),-29.231151096588704).
utility(r("small"),8.463243703868848).
utility(a("adult"),-21.856761086501162).
utility(o("self"),46.17813817366294).
utility(e("high"),-7.585701431355977).
utility(s("M"),-51.60982505061979).
utility(\+(s("M")),30.841917657899916).
utility(t("train"),-20.946953268584682).
