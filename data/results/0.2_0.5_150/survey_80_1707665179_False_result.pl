...
utility(t("other"),32.751872122235305).
utility(\+(t("other")),1.883994178040967).
utility(o("emp"),26.851707166432387).
utility(\+(a("old")),18.182580850809146).
utility(\+(a("adult")),23.835273794480713).
utility(s("M"),-41.77604329055598).
