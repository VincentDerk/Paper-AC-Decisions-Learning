...
utility(\+(bronc),-29.324580869470797).
utility(\+(smoke),48.34420700064901).
utility(either,-33.51120582959395).
utility(\+(dysp),-4.829146021950835).
utility(tub,-13.390956178142698).
utility(xray,-23.20444392204933).
utility(\+(xray),30.334928011301304).
