...
utility(maryCalls,16.429439942255083).
utility(\+(maryCalls),12.88997180458653).
utility(johnCalls,19.00707324314397).
utility(alarm,13.801899100633902).
utility(\+(alarm),15.517512646207706).
