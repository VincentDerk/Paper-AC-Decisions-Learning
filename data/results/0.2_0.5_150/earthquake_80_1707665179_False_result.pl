...
utility(johnCalls,39.020106323343526).
utility(\+(johnCalls),10.171427727260692).
utility(maryCalls,23.283048517925515).
utility(burglary,31.37726976390618).
utility(\+(burglary),17.81426428669802).
