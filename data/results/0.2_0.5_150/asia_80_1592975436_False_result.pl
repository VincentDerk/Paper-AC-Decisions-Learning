...
utility(\+(either),12.39016117849035).
utility(xray,14.819361364046046).
utility(\+(asia),-5.664734382170314).
utility(lung,22.215338025227396).
utility(tub,-39.688173261120504).
utility(dysp,16.660309960662016).
