...
utility(t("car"),19.909489190612867).
utility(r("big"),-44.622988221274376).
utility(r("small"),4.4819798371799).
utility(\+(r("small")),-44.622988221274376).
utility(e("high"),34.13710197389303).
utility(a("young"),-58.04856314534226).
utility(t("other"),14.034229663468441).
