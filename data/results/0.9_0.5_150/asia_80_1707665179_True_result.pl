...
utility(\+(bronc),3.805331631588046).
utility(lung,0.878713609048726).
utility(asia,0.034942808545701).
utility(either,0.883914331805023).
utility(\+(either),3.004565718908447).
utility(tub,0.014030428817849).
