...
utility(t("car"),-41.901942450482416).
utility(a("old"),19.72264138395705).
utility(o("self"),39.186505190815375).
utility(\+(o("self")),-16.046700233403016).
utility(r("small"),-49.609727387567744).
utility(s("F"),-26.846596376218287).
utility(\+(s("F")),49.9864013336305).
utility(\+(o("emp")),39.186505190815375).
utility(a("young"),14.794594807348947).
utility(\+(a("young")),8.345210150063359).
utility(\+(e("uni")),-24.502855272060888).
utility(\+(t("train")),-16.95289201939185).
