...
utility(t("car"),-3.945764260844494).
utility(e("uni"),24.700609082190034).
utility(\+(e("uni")),-59.39547646327035).
utility(o("emp"),-27.093880297829532).
utility(a("old"),-53.481240010552206).
utility(t("train"),29.820854520909897).
utility(t("other"),31.43004235885432).
