...
utility(\+(either),-5.630947127111853).
utility(dysp,22.942490891064487).
utility(lung,2.603713426191494).
utility(smoke,-8.463658547198534).
utility(\+(smoke),12.893308510050694).
utility(bronc,-35.12238773522672).
