...
utility(alarm,11.797326591032311).
utility(\+(alarm),26.160824483875725).
utility(burglary,6.89620141457187).
utility(johnCalls,36.142550961295306).
utility(\+(johnCalls),1.815600113612724).
