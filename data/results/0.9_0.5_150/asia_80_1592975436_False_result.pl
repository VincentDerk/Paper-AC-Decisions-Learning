...
utility(\+(either),20.898537056812113).
utility(dysp,16.14996665513961).
utility(\+(lung),-13.05598790688266).
utility(smoke,55.410689526095915).
utility(asia,-1.537302278087895).
utility(bronc,21.29907469395669).
