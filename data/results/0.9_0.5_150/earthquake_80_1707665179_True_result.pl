...
utility(maryCalls,0.595517906268045).
utility(\+(maryCalls),14.939238033022276).
utility(earthquake,1.727960734073474).
utility(burglary,0.172090225351484).
utility(\+(burglary),15.362665713938839).
