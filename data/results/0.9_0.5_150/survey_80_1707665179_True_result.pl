...
utility(t("car"),0.374148914956051).
utility(o("self"),-31.1906327359989).
utility(\+(t("car")),6.59418181003802).
utility(\+(s("F")),10.094106469496673).
utility(\+(e("uni")),40.02500213982435).
utility(r("big"),-20.58091904112065).
