...
utility(johnCalls,52.14966770419389).
utility(\+(johnCalls),18.601507356005474).
utility(alarm,-34.40530562799709).
utility(burglary,-25.116248340058235).
utility(\+(burglary),9.867423400257582).
