...
utility(\+(bronc),14.137649712319929).
utility(either,16.431796622926495).
utility(tub,26.611536976815803).
utility(dysp,-15.563702917062605).
utility(\+(dysp),-5.807219406011562).
utility(smoke,-46.833877146521445).
