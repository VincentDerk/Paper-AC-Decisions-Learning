...
utility(t("other"),29.174740431653614).
utility(\+(t("other")),11.725520499884059).
utility(t("train"),6.265201328305047).
utility(\+(a("young")),15.27748061160576).
utility(\+(t("car")),35.43994175995867).
utility(a("adult"),-40.63178647092427).
