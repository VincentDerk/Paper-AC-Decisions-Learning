...
utility(\+(xray),13.81343680960047).
utility(smoke,17.987872397639766).
utility(dysp,30.460573636292526).
utility(either,-66.67939322009921).
utility(\+(either),-4.828750179667736).
utility(lung,3.320679298648416).
