...
utility(\+(t("other")),-26.928635450503577).
utility(r("big"),-43.98637527152549).
utility(e("high"),-2.808759501307527).
utility(t("car"),-19.076541645197512).
utility(o("self"),26.15296726349608).
utility(s("M"),-7.422100350827101).
utility(a("adult"),-40.96129672997859).
utility(\+(a("adult")),42.66372182199181).
utility(o("emp"),-24.450542171482844).
