...
utility(r("small"),19.38595547337252).
utility(t("train"),0.11156092127123).
utility(a("old"),25.887477895795083).
utility(e("high"),-19.730087846832593).
utility(s("M"),-45.627011984787146).
utility(\+(r("small")),-45.73751814665927).
utility(t("car"),32.61982472825711).
