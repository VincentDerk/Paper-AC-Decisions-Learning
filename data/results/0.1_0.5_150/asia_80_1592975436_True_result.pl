...
utility(\+(xray),52.46635484040418).
utility(smoke,25.86405218743333).
utility(\+(dysp),-44.61985439131224).
utility(either,39.513726038833475).
utility(asia,0.143364343476714).
utility(lung,30.687051700018745).
