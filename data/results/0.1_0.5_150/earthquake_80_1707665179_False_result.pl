...
utility(maryCalls,38.66050229959184).
utility(\+(maryCalls),11.189578094267162).
utility(alarm,19.400934799752346).
utility(johnCalls,32.35631990605266).
utility(\+(johnCalls),17.493760487806316).
