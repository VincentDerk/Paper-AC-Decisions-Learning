...
utility(t("other"),-8.51123178779583).
utility(r("small"),-15.768938531621805).
utility(e("uni"),16.26760887262063).
utility(e("high"),-26.377398116344228).
utility(s("F"),-18.423182875432275).
utility(s("M"),8.313393631708665).
utility(\+(s("F")),8.313393631708665).
utility(\+(t("train")),-28.775484202541087).
utility(t("car"),-20.264252414745258).
