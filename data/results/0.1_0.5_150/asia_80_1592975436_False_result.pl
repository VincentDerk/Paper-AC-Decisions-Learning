...
utility(\+(bronc),51.445455414529626).
utility(either,9.728191398533117).
utility(\+(tub),-44.134456479104344).
utility(dysp,50.21864279232692).
utility(lung,-9.42277848383604).
utility(smoke,15.685078900268978).
