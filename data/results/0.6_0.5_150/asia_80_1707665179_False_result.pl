...
utility(\+(smoke),12.402861617554187).
utility(asia,2.434343350070353).
utility(bronc,35.430726315508565).
utility(tub,-9.24037333081854).
utility(\+(tub),-5.296693114805617).
utility(lung,-41.53477174432546).
