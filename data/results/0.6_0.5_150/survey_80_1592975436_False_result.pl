...
utility(t("train"),27.504437872213227).
utility(e("high"),6.244403018773747).
utility(o("self"),43.33185940944765).
utility(\+(o("self")),-24.838758003967087).
utility(t("car"),-18.904819619550462).
utility(s("F"),-7.314355101913085).
utility(\+(s("F")),25.807456507393642).
utility(\+(s("M")),-7.314355101913085).
utility(e("uni"),12.248698386706813).
utility(\+(e("uni")),6.244403018773747).
utility(\+(a("young")),-14.157352415841187).
utility(\+(a("adult")),-32.64582975053715).
