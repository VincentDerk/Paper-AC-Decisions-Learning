...
utility(\+(smoke),-27.12110563577315).
utility(\+(bronc),45.75480828114064).
utility(xray,-41.481832963800045).
utility(\+(tub),16.278087076758784).
utility(either,-27.753692373290622).
utility(lung,-13.8566162402928).
utility(\+(lung),16.262142364583493).
