...
utility(\+(lung),-10.679790846806984).
utility(\+(dysp),29.208210444428993).
utility(smoke,-43.54775751280306).
utility(\+(tub),-1.381356338447335).
utility(either,-9.70022330140618).
utility(bronc,-29.86757839490164).
utility(\+(bronc),18.99214958390599).
