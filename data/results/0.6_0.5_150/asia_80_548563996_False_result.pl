...
utility(\+(asia),-19.617687316650454).
utility(bronc,7.730014825325679).
utility(\+(bronc),-29.843760975546978).
utility(xray,2.031051085605021).
utility(\+(xray),-24.14479723582635).
utility(tub,-38.20344902537275).
utility(either,4.185200539824129).
utility(lung,40.55457358552103).
