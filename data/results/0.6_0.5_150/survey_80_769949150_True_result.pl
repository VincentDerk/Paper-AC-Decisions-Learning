...
utility(t("car"),12.617883472152325).
utility(e("high"),-18.00483186180361).
utility(s("M"),27.47859742435553).
utility(\+(r("big")),38.426893008971916).
utility(a("young"),-40.291513536572076).
utility(t("train"),11.88822183303335).
utility(r("big"),-42.836006930508).
utility(r("small"),-20.57310699102807).
utility(\+(a("old")),-38.29121112505647).
