...
utility(t("train"),23.45674281125546).
utility(\+(t("train")),0.45100980524493).
utility(e("high"),17.45734860988111).
utility(\+(o("self")),30.60025061970069).
utility(\+(t("car")),26.778925582842426).
utility(a("young"),-45.04339303192753).
