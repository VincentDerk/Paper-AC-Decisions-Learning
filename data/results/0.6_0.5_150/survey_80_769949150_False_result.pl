...
utility(\+(t("train")),-21.941354306360665).
utility(r("big"),-32.35379135891208).
utility(t("other"),-4.317280903531122).
utility(t("car"),-17.624073402829552).
utility(s("F"),39.78774666800127).
utility(e("uni"),-20.06898133216582).
utility(a("young"),-68.80933735141467).
utility(\+(a("young")),16.006194204605833).
utility(o("emp"),-12.891405425467287).
