...
utility(\+(xray),-33.903737370989575).
utility(dysp,14.903379168462036).
utility(\+(dysp),-29.136695862452388).
utility(smoke,6.44592551355059).
utility(\+(smoke),-20.679242207540984).
utility(tub,-15.899815401934815).
utility(either,-2.071302506093505).
utility(bronc,40.215780662204).
