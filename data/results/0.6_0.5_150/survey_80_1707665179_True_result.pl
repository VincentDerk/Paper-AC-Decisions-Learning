...
utility(a("old"),-0.586207979896792).
utility(\+(a("adult")),27.211015014963742).
utility(r("big"),-22.445828299475654).
utility(\+(e("high")),17.27170439787403).
utility(s("F"),20.464932242117055).
utility(\+(a("old")),-10.50492009808612).
