...
utility(\+(lung),-2.106563144722884).
utility(xray,28.54236717005704).
utility(dysp,10.774714229355387).
utility(tub,-0.016016009787982).
utility(\+(tub),8.759753639399552).
utility(bronc,-23.427640361078318).
