...
utility(johnCalls,41.724200642223366).
utility(\+(johnCalls),9.18255748613018).
utility(earthquake,33.16001617408726).
utility(alarm,32.180527612787806).
utility(\+(alarm),18.726230515565764).
