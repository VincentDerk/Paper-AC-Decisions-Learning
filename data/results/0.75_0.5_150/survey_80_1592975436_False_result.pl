...
utility(o("self"),6.855642342935991).
utility(t("train"),10.083843929358025).
utility(a("adult"),39.78013812509052).
utility(\+(a("adult")),-40.11640338538467).
utility(e("high"),-18.692513636249124).
utility(a("young"),-43.53844352252316).
utility(\+(a("young")),43.20217826222903).
utility(\+(t("other")),19.149351920320964).
utility(r("small"),-2.248647744492675).
utility(\+(r("small")),1.912382484198561).
utility(\+(t("car")),-9.401773251257099).
utility(\+(a("old")),-3.758305397432611).
