...
utility(earthquake,28.012763296894445).
utility(\+(earthquake),12.347808473994794).
utility(johnCalls,21.271619826266633).
utility(maryCalls,24.458243723968522).
utility(\+(maryCalls),15.902328046920696).
