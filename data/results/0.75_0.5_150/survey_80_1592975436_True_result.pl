...
utility(o("emp"),16.055096325394434).
utility(e("high"),27.868425288108906).
utility(o("self"),-43.04426244984164).
utility(\+(o("self")),1.055096325394433).
utility(a("old"),10.836028938909877).
utility(t("train"),22.106235792594912).
utility(\+(t("train")),60.904598082957875).
utility(\+(a("adult")),-23.693211325863487).
utility(a("adult"),37.70404520141628).
utility(\+(s("M")),-32.09109269294785).
utility(\+(t("other")),-21.571545763641524).
utility(\+(e("uni")),-9.131574711891101).
