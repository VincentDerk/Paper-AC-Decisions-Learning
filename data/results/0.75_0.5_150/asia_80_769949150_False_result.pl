...
utility(\+(bronc),-39.60060141684524).
utility(\+(lung),47.057142418422664).
utility(either,-29.91915326353238).
utility(\+(tub),11.083684013629242).
utility(xray,-38.712982028748726).
utility(smoke,-9.228410216833895).
utility(\+(smoke),23.3576710671721).
