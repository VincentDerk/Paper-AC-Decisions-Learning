...
utility(\+(asia),40.5781931944497).
utility(bronc,34.92494969789168).
utility(\+(lung),-27.51569289906495).
utility(xray,23.930864740926687).
utility(either,4.37850463647455).
utility(dysp,-0.724332513645662).
