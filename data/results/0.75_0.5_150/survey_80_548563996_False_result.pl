...
utility(o("self"),13.179733919472435).
utility(\+(o("self")),-21.58778030445492).
utility(s("M"),-14.439952804099795).
utility(e("uni"),-9.191686213054584).
utility(\+(e("uni")),0.783639828072104).
utility(a("young"),58.665419456282265).
utility(t("other"),47.88884204202453).
utility(r("small"),-55.831264991702334).
utility(a("old"),-3.750412988012787).
utility(s("F"),6.031906419117372).
utility(\+(s("F")),-14.439952804099795).
