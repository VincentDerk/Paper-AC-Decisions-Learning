...
utility(o("emp"),20.13837499003405).
utility(e("high"),54.67275667038219).
utility(e("uni"),8.638669697040548).
utility(\+(o("self")),-9.861625009965955).
utility(\+(o("emp")),-12.826948622611303).
utility(\+(a("old")),17.93864559195059).
