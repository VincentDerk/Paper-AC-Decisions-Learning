...
utility(\+(bronc),11.7611115313759).
utility(asia,-1.016336315032164).
utility(lung,25.659368040774968).
utility(tub,3.831475752238787).
utility(\+(tub),-3.145518924353358).
utility(smoke,-43.03386160634508).
