...
utility(johnCalls,39.05090512179023).
utility(\+(johnCalls),12.707349792898444).
utility(burglary,23.852971865634988).
utility(alarm,34.945448139816946).
utility(\+(alarm),16.812806774871728).
