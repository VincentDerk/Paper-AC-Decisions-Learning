...
utility(\+(asia),3.391225589747018).
utility(bronc,-8.004471023945054).
utility(lung,1.212680572931641).
utility(xray,1.14068949532279).
utility(\+(xray),2.321278923385055).
utility(dysp,-9.971630911915016).
