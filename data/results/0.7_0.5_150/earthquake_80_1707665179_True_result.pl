...
utility(maryCalls,59.55443480525875).
utility(\+(maryCalls),34.84010711370008).
utility(earthquake,-21.208136147291842).
utility(johnCalls,12.77537012969564).
utility(\+(johnCalls),-4.38082821073684).
