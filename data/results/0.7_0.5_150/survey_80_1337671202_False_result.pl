...
utility(s("F"),-21.229648171445174).
utility(a("old"),-54.69282386629043).
utility(s("M"),27.287696980719755).
utility(\+(s("M")),-21.229648171445174).
utility(e("high"),44.74340396642637).
utility(t("car"),-25.697260998523223).
utility(o("emp"),17.19123604206929).
