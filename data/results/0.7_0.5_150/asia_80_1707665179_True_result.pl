...
utility(\+(lung),4.318818861672321).
utility(smoke,3.127716401260641).
utility(tub,0.143199661997854).
utility(bronc,0.414926634358023).
utility(\+(bronc),4.70807095175044).
utility(asia,0.042335158912248).
