...
utility(\+(bronc),-20.03465662535806).
utility(\+(smoke),60.707014123685006).
utility(dysp,-38.40456810089508).
utility(\+(either),17.821511833793988).
utility(lung,-14.80434331209871).
utility(asia,-5.336850003154312).
utility(\+(asia),-5.525865357025872).
