...
utility(\+(bronc),7.468957307152481).
utility(tub,8.243718226257986).
utility(smoke,29.800486489713418).
utility(either,-16.389568412467455).
utility(\+(either),3.856765456485292).
utility(asia,-10.550842747316672).
