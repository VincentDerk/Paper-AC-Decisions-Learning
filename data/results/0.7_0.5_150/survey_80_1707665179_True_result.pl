...
utility(e("uni"),24.18731083682409).
utility(t("car"),20.511917610697964).
utility(\+(a("old")),6.296774043114949).
utility(\+(e("uni")),3.119226785919114).
utility(o("emp"),-18.533196170102624).
utility(\+(r("small")),15.202930823690865).
