...
utility(s("F"),32.745196637565236).
utility(\+(s("F")),18.633694876890598).
utility(a("adult"),15.572350501420432).
utility(\+(t("other")),8.342550071915666).
utility(\+(s("M")),32.745196637565236).
utility(e("uni"),-39.83851627206607).
