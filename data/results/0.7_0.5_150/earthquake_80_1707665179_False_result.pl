...
utility(maryCalls,25.295689218018794).
utility(\+(maryCalls),18.46424489764688).
utility(earthquake,25.695594169368196).
utility(alarm,35.72239057175889).
utility(\+(alarm),8.037543543906745).
