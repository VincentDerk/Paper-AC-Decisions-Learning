...
utility(\+(tub),-23.167152870425614).
utility(smoke,7.975813141197134).
utility(\+(smoke),-34.042398360517964).
utility(dysp,-7.959188995823554).
utility(\+(dysp),-18.107396223497243).
utility(either,-14.80658892258525).
utility(lung,-12.118920011871715).
utility(asia,33.22688993109693).
