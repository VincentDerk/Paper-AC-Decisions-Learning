...
utility(\+(bronc),48.07633451667475).
utility(tub,44.76601804950351).
utility(\+(smoke),-41.38211383207472).
utility(either,34.65304859254103).
utility(lung,-10.258502216334835).
utility(asia,-22.262552447548956).
