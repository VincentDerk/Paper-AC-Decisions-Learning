...
utility(\+(smoke),-18.246671843479252).
utility(tub,-0.369822220450124).
utility(\+(tub),-30.001378305127496).
utility(either,0.597781311186905).
utility(\+(either),-30.968981836764517).
utility(bronc,-12.2705554882721).
utility(dysp,-7.100527818865617).
utility(asia,-0.202195367332632).
