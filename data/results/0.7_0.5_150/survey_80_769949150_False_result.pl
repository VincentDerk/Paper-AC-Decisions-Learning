...
utility(\+(s("F")),-22.002909627889437).
utility(a("old"),-44.72162744237578).
utility(r("small"),-9.684683249151995).
utility(s("M"),-22.002909627889437).
utility(r("big"),13.95444447045884).
utility(t("car"),16.239299455416106).
utility(e("uni"),-49.405756943479446).
utility(\+(e("uni")),53.6755181647864).
utility(o("emp"),-19.206992736952227).
