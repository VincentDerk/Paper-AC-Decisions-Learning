...
utility(\+(bronc),-27.015208966341632).
utility(\+(either),49.34693712155693).
utility(asia,-24.79784286206051).
utility(\+(smoke),3.752492433890707).
utility(xray,-21.955992386563572).
utility(dysp,-8.50448745896167).
utility(\+(dysp),23.661867339536332).
