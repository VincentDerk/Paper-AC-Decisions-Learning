...
utility(\+(dysp),51.87384225595376).
utility(lung,18.722423484166484).
utility(\+(xray),-44.90432680028508).
utility(smoke,50.04634658879822).
utility(bronc,-26.91303421370959).
utility(either,25.12850677501032).
