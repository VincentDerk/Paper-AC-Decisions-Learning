...
utility(e("uni"),43.37205644906027).
utility(\+(e("uni")),15.817254407286878).
utility(e("high"),15.817254407286878).
utility(\+(t("car")),18.36913053118361).
utility(\+(r("small")),20.073636573790044).
utility(s("M"),-39.69459236778026).
