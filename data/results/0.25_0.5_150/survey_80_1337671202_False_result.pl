...
utility(e("uni"),-0.146292220812598).
utility(s("F"),-47.21262172579109).
utility(r("small"),23.425706069722274).
utility(\+(r("small")),-9.517817810414128).
utility(r("big"),-9.517817810414128).
utility(a("old"),-19.976956648539844).
utility(a("young"),35.09771190562522).
