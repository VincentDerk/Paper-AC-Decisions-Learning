...
utility(\+(r("small")),0.005890057294401).
utility(\+(o("self")),24.026019876141724).
utility(r("small"),24.810694096164212).
utility(s("M"),-36.22026946581708).
utility(o("emp"),24.026019876141724).
utility(\+(e("uni")),20.825218214378005).
