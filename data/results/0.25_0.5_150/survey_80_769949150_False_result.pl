...
utility(\+(e("uni")),-35.1375780018156).
utility(s("F"),9.978233084904554).
utility(o("self"),-24.418325595532725).
utility(r("small"),-20.196825505779852).
utility(o("emp"),17.652141752896238).
utility(a("old"),-7.530839441129767).
utility(s("M"),-16.74441692754105).
utility(\+(s("M")),9.978233084904554).
utility(a("young"),-17.077571404093856).
