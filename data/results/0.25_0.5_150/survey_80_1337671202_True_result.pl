...
utility(r("big"),1.178147273794568).
utility(\+(o("self")),-24.81432438447108).
utility(r("small"),-27.990968963484708).
utility(t("train"),-15.47586220465433).
utility(a("young"),-47.22759544363637).
utility(t("other"),40.99469682138858).
utility(o("self"),46.00150269478093).
