...
utility(johnCalls,42.71571803703581).
utility(\+(johnCalls),7.294197968698501).
utility(earthquake,17.591882010422612).
utility(burglary,29.694751969600283).
utility(\+(burglary),20.31516403613404).
