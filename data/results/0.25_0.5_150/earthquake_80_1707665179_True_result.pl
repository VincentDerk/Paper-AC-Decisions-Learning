...
utility(maryCalls,55.75165559219291).
utility(\+(maryCalls),35.149875309474176).
utility(burglary,-35.31100107275005).
utility(johnCalls,10.88959464864928).
utility(\+(johnCalls),-5.988063746982211).
