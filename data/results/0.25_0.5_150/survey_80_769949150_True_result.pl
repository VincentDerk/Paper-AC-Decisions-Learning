...
utility(\+(r("small")),-30.195815192772).
utility(t("car"),25.894819778693805).
utility(s("M"),-29.983524231471012).
utility(a("young"),-44.48046512660667).
utility(t("other"),-14.626117860924175).
utility(s("F"),23.809806303502167).
utility(t("train"),-17.442419845738467).
utility(\+(s("M")),23.809806303502167).
utility(o("self"),-8.680340004102924).
