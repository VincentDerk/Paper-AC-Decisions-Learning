...
utility(\+(tub),1.485392326235232).
utility(either,-11.110059391078142).
utility(\+(either),-56.417349596797386).
utility(asia,-46.920190950834595).
utility(\+(asia),-22.60721803704093).
utility(smoke,-38.55579134611609).
utility(xray,19.876437564565155).
utility(dysp,42.652283220209505).
