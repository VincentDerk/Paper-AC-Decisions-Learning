...
utility(\+(bronc),13.063493336122711).
utility(tub,8.454215065267618).
utility(either,24.247639259981167).
utility(smoke,-20.116935538088796).
utility(\+(smoke),-3.885772630682397).
utility(dysp,-40.8281392275145).
