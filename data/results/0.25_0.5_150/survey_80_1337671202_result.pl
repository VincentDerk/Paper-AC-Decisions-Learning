...
utility(s("M"),1.246876313417855).
utility(\+(o("self")),-46.89888927273971).
utility(r("small"),-40.17238395629373).
utility(a("adult"),34.60883487252037).
utility(o("self"),21.427423930469423).
utility(a("young"),-24.841919221809537).
utility(e("high"),25.060099307157625).
