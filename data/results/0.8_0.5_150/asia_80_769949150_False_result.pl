...
utility(\+(bronc),-13.649208680600458).
utility(\+(asia),25.839609458999103).
utility(lung,-47.702035721434136).
utility(\+(tub),10.173536324821555).
utility(dysp,-6.072051149745438).
utility(smoke,-11.73897388196563).
utility(\+(smoke),23.8226444228136).
