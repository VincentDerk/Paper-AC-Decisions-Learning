...
utility(\+(maryCalls),-18.43478297872777).
utility(alarm,-11.26948858177881).
utility(johnCalls,-45.85996303548831).
utility(\+(johnCalls),22.323824142357843).
