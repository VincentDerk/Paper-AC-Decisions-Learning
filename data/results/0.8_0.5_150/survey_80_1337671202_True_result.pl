...
utility(s("M"),-43.35419922796393).
utility(r("big"),-3.787390050300227).
utility(t("train"),-32.77506797705453).
utility(\+(a("old")),-35.478331017097695).
utility(a("old"),23.49059499127462).
utility(e("uni"),22.45995880184727).
utility(s("F"),31.36646320214071).
