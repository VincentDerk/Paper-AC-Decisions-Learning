...
utility(\+(lung),0.833007065716197).
utility(dysp,42.32706307681186).
utility(\+(either),-1.828208882433515).
utility(bronc,22.081904893805127).
utility(smoke,-5.658329138041678).
utility(tub,2.818514051371786).
