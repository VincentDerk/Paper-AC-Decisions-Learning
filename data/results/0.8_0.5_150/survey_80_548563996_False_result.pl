...
utility(a("adult"),14.660601652064345).
utility(\+(a("adult")),-16.133158916526426).
utility(r("small"),3.391136812814342).
utility(a("old"),-1.453113482396159).
utility(\+(a("old")),-0.019443782065974).
utility(t("other"),11.379551699721027).
utility(o("emp"),14.05373409032967).
utility(a("young"),-14.680045434130317).
utility(r("big"),-9.250943824215765).
utility(t("car"),-19.845522846435898).
utility(\+(t("car")),18.372965581973887).
