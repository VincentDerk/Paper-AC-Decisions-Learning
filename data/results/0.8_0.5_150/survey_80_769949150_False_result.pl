...
utility(\+(a("adult")),-35.53533622770222).
utility(r("small"),-62.96690920770072).
utility(a("old"),-2.90926993150783).
utility(e("high"),6.779670196688403).
utility(t("other"),67.60629485675506).
utility(a("young"),-32.62606629619447).
utility(o("self"),-35.09995766898546).
utility(\+(o("self")),34.30975512917068).
utility(t("car"),-25.14771029078641).
