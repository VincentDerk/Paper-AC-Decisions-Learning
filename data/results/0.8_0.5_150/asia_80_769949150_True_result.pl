...
utility(\+(lung),2.413037854996413).
utility(\+(either),52.14630814156322).
utility(asia,-47.7088765398782).
utility(\+(bronc),-8.246984462580741).
utility(smoke,4.749736587387692).
utility(tub,38.3096869487666).
utility(\+(tub),-11.889092131549146).
