...
utility(\+(bronc),40.67348864012523).
utility(either,39.354238279871396).
utility(\+(asia),-34.29393832915597).
utility(tub,6.687615837454629).
utility(dysp,-39.386810244980765).
utility(smoke,9.770315195649456).
