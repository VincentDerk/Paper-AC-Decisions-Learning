...
utility(a("adult"),-17.328250504014317).
utility(r("small"),-16.77813513529546).
utility(e("high"),19.69126177622705).
utility(\+(e("high")),-51.505101436549936).
utility(t("train"),22.716265645865683).
utility(a("young"),-16.618167951597258).
utility(t("car"),28.905687758927858).
