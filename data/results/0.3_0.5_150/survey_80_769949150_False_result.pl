...
utility(\+(s("F")),-2.622907786245501).
utility(r("big"),-33.243608151628386).
utility(e("uni"),-10.182244727514185).
utility(t("train"),-19.539589395010648).
utility(s("M"),-2.622907786245501).
utility(t("car"),-15.34524871844016).
utility(o("self"),-28.66021484043937).
utility(\+(o("self")),11.22048063953613).
utility(o("emp"),11.22048063953613).
