...
utility(\+(dysp),11.118708901023831).
utility(tub,11.623064138444189).
utility(bronc,31.967347296673996).
utility(either,-13.443322121140438).
utility(\+(either),-2.209582767099683).
utility(smoke,-47.937265012121046).
