...
utility(a("old"),-3.112162920712108).
utility(e("uni"),-22.851483630448623).
utility(\+(o("self")),-35.38252898551624).
utility(r("big"),-48.802055240436786).
utility(s("M"),24.177034797760264).
utility(t("train"),27.733693060361617).
utility(o("self"),22.151714171850244).
