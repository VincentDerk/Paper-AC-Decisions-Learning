...
utility(\+(tub),-2.185034664949014).
utility(either,-7.715005065573454).
utility(smoke,30.870755574711815).
utility(dysp,-4.377939424002443).
utility(\+(dysp),10.826713856082057).
utility(lung,-16.482430140301993).
