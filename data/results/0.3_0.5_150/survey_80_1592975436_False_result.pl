...
utility(s("F"),35.314966133969556).
utility(a("old"),-20.788512765882828).
utility(a("young"),20.11562912978695).
utility(\+(a("young")),-16.182067450401142).
utility(t("train"),-4.328669013953243).
utility(s("M"),-31.38140445458372).
utility(\+(s("M")),35.314966133969556).
utility(\+(t("other")),19.217166760916385).
utility(t("car"),23.54583577486964).
utility(\+(t("car")),-19.6122740954838).
utility(\+(o("self")),-27.274007766465978).
utility(\+(a("adult")),-0.672883636095877).
