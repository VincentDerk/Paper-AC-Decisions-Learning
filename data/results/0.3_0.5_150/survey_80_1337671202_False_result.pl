...
utility(s("F"),-0.266162049331184).
utility(r("big"),-44.573042951283696).
utility(t("train"),34.9800489394497).
utility(\+(t("train")),-32.38304976079885).
utility(e("high"),24.48895331056945).
utility(t("car"),-23.521037556862243).
utility(o("emp"),21.228208106027232).
