...
utility(\+(tub),55.257294053756574).
utility(either,7.713575072533945).
utility(\+(smoke),-41.23099308679798).
utility(dysp,47.96722908014997).
utility(xray,-11.845050735190476).
utility(lung,13.565433503325032).
