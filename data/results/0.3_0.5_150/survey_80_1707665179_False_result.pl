...
utility(s("F"),38.07551008884495).
utility(\+(s("F")),10.163786607121649).
utility(a("old"),21.17649450241835).
utility(\+(a("young")),16.702736594250943).
utility(\+(t("train")),24.707873488489078).
utility(o("self"),-41.206684545739).
