...
utility(a("old"),24.84161814670992).
utility(\+(a("old")),-10.03502623437552).
utility(o("emp"),1.303260369299737).
utility(\+(o("self")),1.303260369299737).
utility(\+(r("small")),17.756429917255975).
utility(t("car"),16.449012417022423).
