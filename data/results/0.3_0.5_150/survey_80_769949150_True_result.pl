...
utility(e("high"),15.020540423438266).
utility(\+(o("emp")),-32.161259979743136).
utility(\+(a("old")),-38.323975912519046).
utility(e("uni"),-24.850709796602736).
utility(o("emp"),-27.668909393421348).
utility(r("big"),-33.21696721459059).
utility(a("adult"),0.189402082218894).
utility(t("train"),-12.204662790304956).
utility(o("self"),56.838740020256864).
