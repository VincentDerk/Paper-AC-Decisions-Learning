...
utility(o("self"),46.63512990546948).
utility(s("F"),-37.326288202247945).
utility(a("young"),25.38128135524535).
utility(\+(o("self")),12.397831054483078).
utility(\+(o("emp")),-18.364870094530517).
utility(\+(t("car")),11.932407950615534).
