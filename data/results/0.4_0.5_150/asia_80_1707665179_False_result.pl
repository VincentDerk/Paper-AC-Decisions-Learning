...
utility(\+(dysp),10.636610115948525).
utility(either,17.26766813773854).
utility(lung,25.718950920368215).
utility(smoke,-15.033691945297496).
utility(\+(smoke),-2.525391773299184).
utility(bronc,-47.452017243305214).
