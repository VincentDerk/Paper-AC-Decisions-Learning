...
utility(\+(r("big")),-27.829266500731837).
utility(a("old"),-65.46568732664478).
utility(t("car"),-3.238348690521497).
utility(t("other"),-5.528090012187071).
utility(a("adult"),16.16175748918781).
utility(e("high"),-22.454788749060757).
utility(s("F"),-18.986253384524115).
utility(\+(s("F")),58.512591488910154).
utility(o("self"),-28.58807360492456).
