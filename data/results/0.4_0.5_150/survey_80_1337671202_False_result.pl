...
utility(r("big"),-1.215216609771154).
utility(a("old"),-45.28412918090096).
utility(t("other"),26.10793518413322).
utility(\+(t("other")),-43.48386389548731).
utility(t("train"),25.691669489453314).
utility(e("high"),-19.558564519548213).
utility(o("self"),26.516276154894953).
