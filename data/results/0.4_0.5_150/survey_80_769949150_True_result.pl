...
utility(t("train"),21.61182467395661).
utility(s("F"),-49.593161829070915).
utility(\+(o("self")),-24.074871934904923).
utility(a("old"),-2.15055746095143).
utility(\+(s("F")),37.01188441480963).
utility(o("emp"),-24.074871934904923).
utility(t("other"),-40.705423788773324).
utility(r("small"),0.474030957480979).
utility(r("big"),-13.055308371742273).
