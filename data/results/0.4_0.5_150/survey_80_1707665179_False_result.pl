...
utility(r("big"),20.705628321788932).
utility(\+(r("big")),-7.056445556406563).
utility(s("M"),35.56863400376139).
utility(\+(r("small")),20.705628321788932).
utility(\+(t("other")),21.773524207074736).
utility(s("F"),-21.919451238379025).
