...
utility(\+(lung),-15.10076067640566).
utility(\+(bronc),47.17852495610055).
utility(xray,-42.467928260908316).
utility(\+(dysp),5.421306939860597).
utility(asia,0.008444214393036).
utility(either,-23.61927930813284).
utility(\+(either),6.737750552935254).
