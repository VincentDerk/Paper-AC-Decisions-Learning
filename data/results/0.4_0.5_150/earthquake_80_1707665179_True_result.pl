...
utility(johnCalls,39.703462396905735).
utility(\+(johnCalls),8.346023655931274).
utility(earthquake,38.985112900281926).
utility(alarm,19.4979196847149).
utility(\+(alarm),19.55156636812213).
