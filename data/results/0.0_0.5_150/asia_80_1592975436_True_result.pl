...
utility(\+(asia),44.55540796963597).
utility(tub,11.509783154625069).
utility(\+(either),-36.788843680686156).
utility(lung,44.26778459286773).
utility(xray,-18.72305424369329).
utility(smoke,15.185475021007232).
