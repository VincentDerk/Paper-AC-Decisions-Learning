...
utility(\+(tub),-35.556671053266314).
utility(either,-2.399040892569919).
utility(\+(either),-21.157630160696407).
utility(dysp,-6.790552475045249).
utility(\+(dysp),-21.76611857822108).
utility(lung,-35.39904089256991).
utility(xray,33.59805077160163).
utility(smoke,48.69190436982926).
