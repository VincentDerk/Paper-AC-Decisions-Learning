...
utility(s("F"),-22.499916973592264).
utility(o("self"),-45.999055483114994).
utility(s("M"),21.000349852797758).
utility(\+(s("M")),-22.499916973592264).
utility(e("uni"),26.999741344258705).
utility(t("car"),-21.0006183175999).
utility(t("train"),31.99955571103975).
