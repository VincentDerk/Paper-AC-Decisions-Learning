...
utility(s("F"),32.73605227853487).
utility(a("adult"),26.55065960052486).
utility(t("other"),49.40563832132995).
utility(\+(t("other")),-37.73803913718562).
utility(s("M"),-21.06845309439054).
utility(e("high"),-33.38654965309653).
utility(\+(e("high")),45.05414883724084).
utility(\+(a("old")),41.49127632868669).
utility(t("car"),13.070009932507789).
utility(\+(t("car")),-1.402410748363436).
utility(\+(o("emp")),-24.920608665902165).
utility(\+(r("small")),-48.02666966552894).
