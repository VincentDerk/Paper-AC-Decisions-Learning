...
utility(s("F"),22.659195549026098).
utility(\+(s("F")),-8.158451390111175).
utility(a("adult"),19.848436555858793).
utility(\+(t("other")),17.679780671755363).
utility(\+(s("M")),22.659195549026098).
utility(o("emp"),-23.272028429863482).
