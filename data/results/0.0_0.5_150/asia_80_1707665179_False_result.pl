...
utility(\+(bronc),11.852677900356213).
utility(asia,15.626564417833057).
utility(smoke,32.11189636630917).
utility(xray,-17.78736595751827).
utility(\+(xray),-2.734732905488118).
utility(dysp,-46.222347157695495).
