...
utility(\+(e("high")),-32.65171102804073).
utility(r("big"),0.056110140856988).
utility(e("high"),33.36626588964643).
utility(a("adult"),14.589985237319741).
utility(s("M"),-45.94865663872623).
utility(a("young"),-33.422617608598244).
utility(a("old"),19.547187232884177).
