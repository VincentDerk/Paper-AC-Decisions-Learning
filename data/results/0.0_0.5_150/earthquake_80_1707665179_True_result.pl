...
utility(johnCalls,38.96055828447797).
utility(\+(johnCalls),7.081535029197256).
utility(burglary,14.237554977102373).
utility(alarm,25.14297444253902).
utility(\+(alarm),20.899118871136196).
