...
utility(\+(bronc),-29.748765359967035).
utility(\+(smoke),48.319115742816436).
utility(lung,-43.25489250903052).
utility(\+(xray),8.12004447559384).
utility(tub,-5.542288933954364).
utility(dysp,-13.220530622408065).
utility(\+(dysp),23.12205543424839).
