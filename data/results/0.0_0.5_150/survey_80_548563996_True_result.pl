...
utility(s("M"),-28.874945182382643).
utility(r("big"),55.23075928537275).
utility(t("other"),-18.625970037864843).
utility(t("train"),-18.266824494620515).
utility(\+(a("old")),-22.131724120658355).
utility(a("young"),-37.931552878871365).
utility(\+(r("big")),24.578110240211156).
utility(\+(t("car")),38.107205467514625).
utility(t("car"),-46.29833594193072).
utility(r("small"),-2.421889759788842).
utility(a("old"),-27.05940635375774).
