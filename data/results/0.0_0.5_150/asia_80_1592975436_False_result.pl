...
utility(\+(bronc),50.076065753417105).
utility(asia,0.0).
utility(\+(smoke),-42.94659479725114).
utility(xray,48.99296373137633).
utility(tub,-26.341471379845764).
utility(dysp,15.080110187539322).
