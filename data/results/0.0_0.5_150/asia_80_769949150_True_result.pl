...
utility(\+(asia),-7.679563123027829).
utility(\+(either),20.551495727053652).
utility(dysp,-47.68824966886812).
utility(\+(lung),20.551495727053652).
utility(xray,-22.547822870746735).
utility(smoke,-21.39576901997966).
utility(\+(smoke),17.09478261961904).
